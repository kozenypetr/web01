...
<html lang="en">
  ...
  <body>
    ...
    <div id="container">
      ...
      <div class="company-ever section">
        <div class="container">
          <div class="row company-bg">
            <div class="col-md-6">
              <div class="company-thumb">
                <img src="assets/img/featured/img-1.png" alt="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="content">
                <h2>Hire us and <span>Get Started!</span></h2>
                <p>There are many variations of passages of Lorem Ipsum available, but the majority Have suffered alteration in some form, by injected humour, or randomised words Which don't look even slightly believable.</p>
                <div class="compayt-button">
                  <a href="#" class="btn btn-effect">Contact Us <i class="icon-envelope"></i></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Start Call to Action Section -->
        <div class="cta">
          <div class="container">
            <div class="row">
              <div class="col-md-10">
                <h2>Looking quality constructor for your project?</h2>
              </div>
              <div class="col-md-2">
                <a href="#" class="btn btn btn-border btn-small">Hire Us Now</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="copyright-section">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              <p>
                Copyright &copy; 2015 ConBiz - Designed & Developed by 
